...
Campaign.map((datas, index) => (  
  ...
  <br/>
    ...
    function ModifyData(e){
      ...
      fetch('http://localhost:5000/api/news/1', requestOptions)
        .then(response => response.json())
        .then(data => "balasan : "+console.log(data));
    }
    //Delete (Hapus data)
    function DeleteAdd(e){
      e.preventDefault();
      fetch('http://localhost:5000/api/news/1', { method: 'DELETE' })
                ...
                <div className="row">
                    ...
                    <div class="col-md-9 stretch-card grid-margin">
                        <Card>
                            ...
                            <Card.Body>
                                <Button href="http://localhost:3000/Berita/List-all-berita"className='txt-right'style={{float:'right'}}>Lihat Semua</Button>
                            </Card.Body>
                        </Card>
                  ...
                  <Card.Body>
                    <div class="row">
                      ...
                      <Card>
                        ...
                        <Card.Body>
                                <Button href="http://localhost:3000/Campaign"className='txt-right'style={{float:'right',fontSize: 10}}>Lihat Semua</Button>
                            </Card.Body>
                        </Card>
